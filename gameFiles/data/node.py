...
class Node:
    ...
    def __init__(self, value, center, textContent, game):
        ...
        self.nodeClickSound = pygame.mixer.Sound("data/assets/sounds/nodeClick1.wav")
        #self.nodeClickSound = pygame.mixer.Sound("data/assets/sounds/Click.wav")
        #self.errorSound = pygame.mixer.Sound("data/assets/sounds/Lose.wav")
        self.errorSound = pygame.mixer.Sound("data/assets/sounds/errorClick.mp3")
        self.children = []
        self.clicked = False
        self.time = 0
        self.game = game
    ...
    def draw(self, surface):
        ...
        if distance < self.radius and time.time() - self.time < 0.05:
            if pygame.mouse.get_pressed()[0] and self.clicked == False:
                if self.value == "x2" or self.value == "Only Positive" or self.value == "Time Freeze" or self.value >= 0:
                    pygame.mixer.Sound.play(self.nodeClickSound)
                else:
                    pygame.mixer.Sound.play(self.errorSound)
                self.clicked = True
