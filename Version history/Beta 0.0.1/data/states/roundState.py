...
class RoundState(State):
    def __init__(self, game, variables):
        ...
        startButtonImg = pygame.image.load(os.path.join("data/assets", "startBtn.jpg"))
        self.analysisButton = Button(400, 400, startButtonImg, .3, 'tab', game)
    #     self.readValues()
    ...
    def drawAnalysisBox(self, surface):
        ...
        multiplierSurface = self.font.render("Multiplier:           " + str(self.multiplier), True, (0,0,0))
