...
class UpgradeState(State):
    def __init__(self, game):
        ...
        self.roundButtonImage = pygame.image.load(os.path.join(assetsDir, "roundButton.png"))
        self.roundButton = Button(game.gameWidth-144, game.gameHeight-87, self.roundButtonImage, .5, 'shift', game)
